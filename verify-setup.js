...
async function main() {
  ...
  console.log("   SELECT policyname, cmd FROM pg_policies WHERE tablename = 'teachers';");
  console.log('');
  ...
  console.log(`Teachers table working: ${teachersTableWorks ? '✅ Yes' : '❌ No'}`);
  console.log(`Invitation tokens table: ${invitationsTableWorks ? '✅ Yes' : '❌ No'}`);
  console.log('');
